...
//
// If two different instance of ProgressBar try to display a progress only one will be displayed.
...
// TrackProgress instantiates a new progress bar that will display the progress of stream until closed.
// totalSize can be 0.
